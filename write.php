            ...
            <div class="row">
                <div class="col-md-12" style="width:100%; height:100%;">
                    <form method="POST" action="write_proc.php" enctype="multipart/form-data">
                        <div class="col-md-12 mt-4 mb-2"><input style="width: 100%; padding: 10px;" type="text" name="article_title"></div>
                        <div class="col-md-12 mt-2 mb-2"><textarea name="article_body" rows="30" style="width: 100%; padding: 10px;"></textarea></div>
                        <div class="col-md-12 mt-2 mb-2"><label for="article_thumbnail">썸네일 이미지</label><input style="width: 100%;" type="file" id="article_thumbnail" name="article_thumbnail"></div>
                        <div class="col-md-12 mt-2 mb-2"><label for="article_mp3">미리듣기 mp3파일</label><input style="width: 100%;" type="file" id="article_mp3" name="article_mp3"></div>
                        <button class="btn btn-outline-primary my-2 my-sm-0" style="float: right;" type="submit">쓰기</button>
                    </form>
                </div>
            </div>
        </div>
