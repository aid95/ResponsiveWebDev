...
<head>
    ...
    <script>
        ...
        {
            var obj_form = document.signupform;

            if (obj_form.uid.value == "")
            {
                alert("아이디를 입력해주세요.");
                return;
            }
            else if (obj_form.upw.value == "")
            {
                alert("비밀번호를 입력해주세요.");
                return;
            }
            else if (obj_form.upw.value != obj_form.cpw.value)
            {
                alert("비밀번호 확인이 다릅니다.");
                return;
            }
            else if (obj_form.unick.value == "")
            {
                alert("닉네임을 입력해주세요.");
                return;
            }
                ...
                <div class="col-md-12" style="margin: 0 auto; max-width: 480px;">
                    ...
                    <div class="col-sm-12">
                        ...
                        <div class="mb-4">
                            ...
                            <div class="col-sm-12" style="padding: 4px; border-bottom: 1px solid #3c99dc;">
                                <input class="form-control mr-sm-2" name="cpw" style="border: 0px solid #fff;" type="password" placeholder="비밀번호 확인" aria-label="비밀번호 확인">
                            </div>
                            <div class="col-sm-12" style="padding: 4px; border-bottom: 1px solid #3c99dc;">
                                <input class="form-control mr-sm-2" name="unick" style="border: 0px solid #fff;" type="text" placeholder="닉네임" aria-label="닉네임">
                            </div>
                        </div>
                        </form>
                        <div class="col-sm-12 mt-2">
                            <button class="btn btn-success my-2 my-sm-0" onclick="javascript:valid_check()" style="width: 100%;">가입하기</button>
                        </div>
                        <hr>
                    </div>
                </div>
